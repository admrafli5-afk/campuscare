        ...
        SnackBar(
          content: Text(
            clinicStatus == null
                ...
                : 'Klinik sedang tutup. Antrean tidak tersedia.',
          ),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            clinicStatus == null
                ? 'Status klinik belum dimuat. Tekan refresh terlebih dahulu.'
                : 'Klinik sedang tutup. QR antrean tidak tersedia.',
          ),
          backgroundColor: Colors.red,
        ),
      );
      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            _ClinicStatusCard(
              status: clinicStatus,
              isLoading: isLoadingClinicStatus,
              errorMessage: clinicStatusError,
              onRefresh: () => loadClinicStatus(silent: false),
            ),
            ...
            _QueueHeroCard(
              ...
              onRegisterTap: handleRegisterQueueTap,
...
class _ClinicStatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color badgeColor = isOpen ? AppColors.primaryGreen : Colors.red;
    final Color badgeBackground =
        isOpen ? AppColors.softMint : const Color(0xFFFFE4E6);

    final String title = isLoading && status == null
        ? 'Memuat Status Klinik'
        : status?.statusText ?? 'Status Klinik Tidak Tersedia';

    final String subtitle = isLoading && status == null
        ? 'Sedang mengambil data dari server...'
        : isOpen
            ? 'Kami siap melayani Anda'
            : 'Pendaftaran antrean sedang ditutup';

    final String badgeText = isLoading && status == null
        ? '...'
        : isOpen
            ? 'Buka'
            : 'Tutup';
    ...
    final String operationalTime =
        status == null ? '-' : '${status!.openTime} - ${status!.closeTime} WIB';
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: isClinicOpen ? onRegisterTap : null,
                        icon: Icon(
                          isClinicOpen
                        ...
                        label: Text(
                          isClinicOpen ? 'Ambil Antrean' : 'Klinik Tutup',
